                    ...
                    <div className="col-lg-3">
                      <div className="row my-3">
                        <div className="col-sm-12 map-container-btn text-center">
                          <a href="https://earth.google.com/web/@28.39745565,84.12999775,2263.95525314a,1308780.3687781d,35y,0h,0t,0r/data=ClYaUBJKCiUweDM5OTVlOGM3N2QyZTY4Y2Y6MHgzNGEyOWFiY2QwY2M4NmRlGb-YLVkVZTxAIU8cQL_vB1VAKg_guYDguJnguJvguLLguKUYAiABQgIIAToDCgEwSg0I____________ARAA">
                            <button
                              type="button"
                      ...
                      <div className="row mt-2 justify-content-between">
                        ...
                        >
                          <Form.Select aria-label="Default select example">
                            ...
                            <option value="2">Best Hotels</option>
                            <option value="3">Tiger Palace</option>
                            <option value="4">
                              Holiday Inn Hotels & Resorts
                            </option>
                            <option value="5">Malla HOTEL</option>
                            <option value="6">
                              SOLTI Hotel
                            </option>
                          </Form.Select>
